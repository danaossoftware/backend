...
if ($c->query("UPDATE questions SET question='" . $question . "', answers='" . $answers . "', correct_answer='" . $correctAnswer . "', picture_url='" . $pictureURL . "', video_url='" . $videoURL . "' WHERE id='" . $questionId . "'")) {
    echo 0;
} else {
    echo -1;
}